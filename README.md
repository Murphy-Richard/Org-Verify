...
Place these three files next to `index.html` (same folder):
- `jobberman.png` — Jobberman JB logo (top-left of the page)
- `logo.png` — Mastercard Foundation logo (top-right of the page)
- `favicon.ico` — Jobberman JB favicon

If these files are missing, the page still works fine — the logo slots and
